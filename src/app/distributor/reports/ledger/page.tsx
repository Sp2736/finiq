    ...
    <div className="relative flex-1 w-full min-h-[calc(100vh-5rem)] flex flex-col p-4 sm:p-6 lg:p-8 animate-in fade-in slide-in-from-bottom-2 duration-500 ease-out">
      ...
      {showAddBank && (
        <div className="absolute inset-0 z-[100] rounded-xl overflow-hidden">
          <div
            className={`absolute inset-0 bg-white-900/40 backdrop-blur-sm transition-all ${isClosingBank ? "animate-out fade-out duration-250" : "animate-in fade-in duration-200"}`}
            ...
            >
              <div className="flex justify-between items-center bg-white border-b border-slate-100 p-5 px-6 shrink-0">
                ...
                <button
                  ...
                  className="p-2 text-slate-400 hover:text-slate-700 rounded-full transition-all"
                >
                  <X className="w-5 h-5" />
                </button>
              </div>
              ...
              <div className="p-6 md:p-8 overflow-y-auto bg-slate-50/50 flex-1 space-y-6 pb-20">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <input
                    ...
                    disabled={isSubmittingBank}
                    className="w-full p-3 bg-white border border-slate-200 rounded-xl text-sm font-semibold focus:border-distributor-500 outline-none transition-all shadow-sm"
                  />
                  <input
                    type="text"
                  ...
                  <input
                    ...
                    disabled={isSubmittingBank}
                    className="w-full p-3 bg-white border border-slate-200 rounded-xl text-sm font-semibold uppercase focus:border-distributor-500 outline-none transition-all shadow-sm"
                  />
                  <input
                    type="text"
                    value={newBank.upiId}
                    ...
                    disabled={isSubmittingBank}
                    className="w-full p-3 bg-white border border-slate-200 rounded-xl text-sm font-semibold sm:col-span-2 focus:border-distributor-500 outline-none transition-all shadow-sm"
                  />
                </div>
                ...
                <div
                  ...
                  className={`mt-4 flex items-center justify-between p-4 rounded-xl border cursor-pointer transition-all ${newBank.isPrimary ? "bg-distributor-50 border-distributor-200" : "bg-white border-slate-200 hover:bg-slate-50"}`}
                >
              ...
              <div className="p-5 px-6 bg-white border-t border-slate-100 flex justify-end gap-3 shrink-0">
                <button
                  onClick={handleCloseAddBank}
                  disabled={isSubmittingBank}
                  className="px-6 py-2.5 rounded-lg text-sm font-bold text-slate-600 bg-white border border-slate-200 hover:bg-slate-50"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="flex items-center gap-2 px-8 py-2.5 bg-distributor-600 text-white rounded-lg text-sm font-bold shadow-sm hover:bg-distributor-700 disabled:opacity-50 transition-all"
                >
                  {isSubmittingBank ? (
      ...
      {showConfirm && (
        <div className="absolute inset-0 z-[100] rounded-xl overflow-hidden">
          <div
            className={`absolute inset-0 bg-white-900/40 backdrop-blur-sm transition-all ${isClosingConfirm ? "animate-out fade-out duration-250" : "animate-in fade-in duration-200"}`}
            onClick={handleCloseConfirm}
          />

          <div className="sticky top-0 w-full h-[calc(100vh-5rem)] flex items-center justify-center p-4 sm:p-6 pointer-events-none">
            <div
              className={`relative w-full max-w-4xl bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-full pointer-events-auto border border-slate-200/50 transition-all ${isClosingConfirm ? "animate-out zoom-out-95 fade-out duration-200" : "animate-in zoom-in-90 fade-in duration-200"}`}
            >
              <div className="flex justify-between items-center bg-white border-b border-slate-100 p-5 px-6 shrink-0">
                <div>
                  <h3 className="text-lg font-black text-slate-800">
              ...
              <div className="p-5 px-6 bg-white border-t border-slate-100 flex justify-end gap-3 shrink-0">
                <button
                  onClick={handleCloseConfirm}
                  disabled={isSubmittingTransfer}
                  className="px-6 py-2.5 rounded-lg text-sm font-bold text-slate-600 bg-white border border-slate-200 hover:bg-slate-50 disabled:opacity-50"
                >
                  Go Back
                </button>
                <button
