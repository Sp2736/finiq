...
const REPORTS = [
  { id: 1, title: 'AUM Summary', description: 'Comprehensive view of assets under management across all active clients.', icon: PieChart, color: 'text-distributor-600', bg: 'bg-distributor-50' },
      ...
      <div className="shrink-0 flex flex-col md:flex-row justify-between items-start md:items-end gap-4 mb-6">
        <div>
          <h1 className="text-3xl font-black tracking-tight text-slate-900">
            Analytic <span className="text-transparent bg-clip-text bg-gradient-to-r from-distributor-600 via-teal-600 to-distributor-800">Reports</span>
          </h1>
