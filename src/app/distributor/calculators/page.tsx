...
// const CALCULATORS = [
//   { id: 1, name: 'SIP Calculator', description: 'Calculate wealth accumulation through regular monthly investments.', icon: TrendingUp, color: 'text-distributor-600', bg: 'bg-distributor-50' },
...
//             Financial <span className="text-transparent bg-clip-text bg-gradient-to-r from-distributor-600 via-teal-600 to-distributor-800">Calculators</span>
//           </h1>
...
//             <div key={calc.id} className="bg-white p-6 md:p-8 rounded-md border border-slate-200 shadow-sm hover:border-distributor-200 transition-all group flex flex-col sm:flex-row items-start sm:items-center gap-6 cursor-pointer relative overflow-hidden">
...
//                 <h3 className="text-xl font-black text-slate-900 tracking-tight mb-1 group-hover:text-distributor-700 transition-colors">{calc.name}</h3>
//                 <p className="text-sm text-slate-500 font-medium leading-relaxed">{calc.description}</p>
//               </div>
//               <div className="hidden sm:flex w-10 h-10 rounded-full bg-slate-50 items-center justify-center group-hover:bg-distributor-50 transition-colors shrink-0">
//                 <ChevronRight className="w-5 h-5 text-slate-400 group-hover:text-distributor-600" />
//               </div>
//             </div>
//           ))}
//         </div>
