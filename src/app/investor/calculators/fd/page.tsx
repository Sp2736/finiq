...
const calculateFD = (
  ...
  if (type === "CUMULATIVE") {
    ...
    if (type === "MONTHLY") periodicPayout = (principal * r) / 12;

    if (type === "QUARTERLY") periodicPayout = (principal * r) / 4;

    if (type === "HALF_YEARLY") periodicPayout = (principal * r) / 2;

    if (type === "YEARLY") periodicPayout = principal * r;
