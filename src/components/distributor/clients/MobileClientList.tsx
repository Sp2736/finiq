    ...
    <div className="flex flex-col gap-2 p-2">
      {clients.map((client) => (
        <div
          ...
          className="bg-white rounded-xl border border-slate-200 shadow-sm transition-all duration-200 active:scale-[0.98] active:bg-slate-50 cursor-pointer group hover:border-distributor-300"
        >
          <div className="p-3 md:p-4 flex items-center justify-between">
            ...
            <div className="p-1.5 rounded-lg bg-slate-50 text-slate-400 group-hover:bg-distributor-100 group-hover:text-distributor-600 transition-colors">
