                ...
                return (
                  <React.Fragment key={fund.folioNo}>
                    ...
                    >
                      ...
                      <td className="px-3 py-4 text-slate-500 font-medium tabular-nums">{fund.purchaseDate}</td>
                      <td className="px-3 py-4 text-right font-medium text-slate-600 tabular-nums">{formatCurrency(fund.investedCapital)}</td>
                      <td className="px-3 py-4 text-right font-bold text-slate-900 tabular-nums">{formatCurrency(fund.currentValue)}</td>
                      <td className="px-3 py-4 text-right text-slate-500 tabular-nums">{fund.availableUnits.toFixed(3)}</td>
                      ...
                      <td className="px-3 py-4 text-right font-medium text-slate-500 tabular-nums">{formatCurrency(fund.dividendPayout)}</td>
                      <td className="px-3 py-4 text-right tabular-nums">
                          ...
                          <div className="overflow-hidden">
                            <div className="p-5 pl-12 border-l-[3px] border-investor-300 ml-4 my-3">
                              ...
                              <div className="mb-3 flex items-center justify-between">
                                <h4 className="text-[11px] font-bold uppercase tracking-widest text-investor-700 flex items-center gap-2">
